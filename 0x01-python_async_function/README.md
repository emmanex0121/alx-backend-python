...
```
phoenix@phoenix-PC:~$ cat 0-main.py
#!/usr/bin/env python3
...
```
phoenix@phoenix-PC:~$ cat 1-main.py
#!/usr/bin/env python3
'''
...
```
phoenix@phoenix-PC:~$ cat 2-main.py
#!/usr/bin/env python3
...
```
phoenix@phoenix-PC:~$ cat 3-main.py
#!/usr/bin/env python3
...
```
phoenix@phoenix-PC:~$ cat 4-main.py
#!/usr/bin/env python3
